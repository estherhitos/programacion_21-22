 ...
 * sobre las asignaturasque se imparten en el curso. 
 * Cada pregunta acertada sumará un punto. El programa mostrará al final 
 * la calificación obtenida. Pásale el minicuestionario a tus compañeros
 * y pídeles que lo hagan paraver qué tal andan deconocimientos en 
 * las diferentes asignaturas del curso.
 * 
 * @Authora: Esther Hitos Garcia
 */
 
 public class Ej12 { // Clase principal
  public static void main(String[] args) {
    ...
    //Puntuación
    System.out.println(b+"La puntuación que ha sacado en este test es de: \n" + puntos);
    if (puntos < 5){
